<%-- 
    Document   : IndexUsers
    Created on : 24 may. 2024, 12:15:39 p. m.
    Author     : ALAN
--%>
...
<body>
    <div class="contenedor">
        ...
        <header class="header">
            ...
            <nav class="menu">
                <ul class="navegacion">
                    ...
                    <a href="cerrarsesion.php" class="btn btn-danger"><b>Cerrar Sesion</b></a>
                </ul>
            </nav>
        ...
        <main class="comida">
            ...
            <div class="platos">
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/HAMBURGUESA DOBLE CARNE.jpg"
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/CLUB SANDWICH.jpg" alt="CLUB SANDWICH">
                    <h1>&#x22B3;Club Sandwich&#x22B2;</h1>
                    <p>•Palta<br>
                        •Papas fritas<br>
                        •Chorizo<br>
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/SALCHI ROYAL.jpg" alt="SALCHI ROYAL">
                    <h1>&#x22B3;Salchi Royal&#x22B2;</h1>
                    <p>•Queso<br>
                        •Papas fritas<br>
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/SALCHI TAYPA.jpg" alt="SALCHI TAYPA">
                    <h1>&#x22B3;Salchi Taypa&#x22B2;</h1>
                    <p>•Chorizo<br>
                        •Papas fritas<br>
                        •Salchicha nacional<br>
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/BISTECK A LO POBRE.jpg" alt="BISTECK A LO POBRE">
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/MOSTRITO.jpg" alt="MOSTRITO ">
                    <h1>&#x22B3;Mostrito&#x22B2;</h1>
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/TALLARIN SALTADO.jpg" alt="TALLARIN SALTADO ">
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/ALITAS BBQ.png" alt="ALITAS BBQ ">
                    <h1>&#x22B3;Alitas BBQ&#x22B2;</h1>
            ...
            <div class="platos">
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/bebidas taypa.jpg" alt="bebidas taypa">
                ...
                <article class="plato">
                    <img src="${pageContext.request.contextPath}/IMGS/IMGS TAYPA FASTFOOD PROYECTO/jugos taypa.jpg" alt="jugos taypa">
